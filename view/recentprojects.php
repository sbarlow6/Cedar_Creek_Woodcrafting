    ...
    <a href="index.php">
        ...
        <div class="blocker"></div>
            ...
            <ul>
                ...
                <li><a href= ".?action=recentprojects" title= "Go to the recent projects page" class="active">Recent Projects</a></li>
        ...
        <BR><BR><BR><BR><BR><BR>
            <div class="container"><div class="col-xs-12"><h2>Recent Projects</h2></div></div>
             <?php foreach ($result as $one) : ?>
             <div class="proj container">
           	<div class="col-sm-6 projdesc">
           <h3><?php echo $one['projectName'];?></h3> 
            <?php echo $one['projectDescription'];?></div><div class="col-sm-6">
            <?php 
            if($one['video'] == 1) {
